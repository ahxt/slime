...
MULTI_AGENT_CONFIGS = {
    "custom_multi_agent_function_path": "examples.multi_policy_two_agent.agent_system.run_agent_system",
    # num_parallel must match n_samples_per_prompt for solver / selector in
